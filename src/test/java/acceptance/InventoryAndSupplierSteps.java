...
import cookingsystem.features.inventorymanagement.*;
import java.util.*;

public class InventoryAndSupplierSteps {
    private InventoryManagement inventory = new InventoryManagement();
    private List<InventoryManagement.SupplierPrice> supplierPrices;
    ...
    public void setupSuppliers(String item) {
        ...
        supplierPrices.add(new InventoryManagement.SupplierPrice("OlivePro Ltd", 5.20));
        supplierPrices.add(new InventoryManagement.SupplierPrice("Green Harvest", 4.95));
        supplierPrices.add(new InventoryManagement.SupplierPrice("OrganicOils", 5.10));
    ...
    public void viewInventory() {
        ...
        supplierPrices.sort(Comparator.comparingDouble(InventoryManagement.SupplierPrice::getPricePerLiter));
    }
