...
import cookingsystem.features.schedulingandtaskmanagement.SchedulingAndTaskManagement;
...
public class SchedulingAndTaskManagementSteps {
    ...
    public void systemShouldUpdateChefTaskList(String chefName) {
        ...
        Assertions.assertTrue(tasks.contains(currentTask),
                "Expected task not found in chef's task list.");
    }
