package cookingsystem.features.orderandmenucustomization;
...
public class OrderAndMenuCustomization {
    ...
    private String dish;
    private List<String> ingredients = new ArrayList<>(); // قائمة مكونات الطبق
